...
T = 1095  # sample size (number of datapoints in time series. You may need to add zeros to smaller datasets, so that all of them are the same length )
S = 25  # number stocks or funds or cyrptocurrencies
