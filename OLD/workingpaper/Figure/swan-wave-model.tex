...
\begin{tikzpicture}[scale=.9,every node/.style={minimum size=1cm},on grid]
  ...
  \begin{scope}[
    ...
    %2st layer Complexity reduction
    \begin{scope}[
    ...
    \begin{scope}[
      ...
      %5th layer Visualization
    \begin{scope}[
        yshift=-170,every node/.append style={
        yslant=0.5,xslant=-1},yslant=0.5,xslant=-1
                  ]
        %marking border
        \fill[white,fill opacity=.25] (0,0) rectangle (5,5);
        \draw[step=5mm, black] (0,0) grid (5,5);
        %\draw[step=2mm, green] (2,2) grid (3,3);
        \draw[black,very thick] (0,0) rectangle (5,5);
        \draw[black,dashed] (0,0) rectangle (5,5);
    ...
    \draw[-latex,thick] (6.2,2) node[right]{$\mathsf{Interactions\ within-\ between\ species}$}
    to[out=180,in=90] (4,2);

    %\draw[-latex,thick] (5.9,8.4) node[right]{$\mathsf{Visualization}$}
    %     to[out=180,in=90] (3.2,8);

    \draw[-latex,thick](5.8,-.3) node[right]{$\mathsf{Interactions\ abiotic\ environment}$}
        to[out=180,in=90] (3.9,-1);

    \draw[-latex,thick](5.9,5) node[right]{$\mathsf{Phenotypes}$}
      to[out=180,in=90] (3.6,5);

    \draw[-latex,thick](5.9,8.4) node[right]{$\mathsf{Genetic\ interactions}$}
        to[out=180,in=90] (3.2,8);
    ...
    \draw[-latex,thick](4,-6) node[right]{$\mathsf{Species\ distributions}$}
        to[out=180,in=90] (2,-5);	


        % Connecting Layers
        \draw[-latex,thick,red](2,3) node[right]{$\mathsf{}$}
        to[out=180,in=90] (2,-.5);

        \draw[-latex,thick,red](2,3) node[right]{$\mathsf{}$}
        to[out=180,in=90] (2,6);

        \draw[-latex,thick,red](2,6) node[right]{$\mathsf{}$}
        to[out=180,in=90] (2,8.5);
        
        \draw[-latex,thick,red](2,3) node[right]{$\mathsf{}$}
        to[out=180,in=90] (0,-2.5);

        \draw[-latex,thick,red](0,-2.5) node[right]{$\mathsf{}$}
        to[out=180,in=90] (2,-3.75);
