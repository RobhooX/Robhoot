...
function load_params(;bs, ss, as, es, is, dss, dlats, dincs, dis, drs,
  ...
  parameters = Dict(:C=>C, :countries => popnames[popindices], :m => Binomial.(popmat, migration_rates), :Ns => Ns, :Ss=>Ss, :latents => latents, :incubations => incubations, :Is=>Is, :Rs=>Rs, :bs=>bs, :ss=>ss, :as=>as, :es => es, :is => is, :dss=>dss, :dis=>dis, :drs =>drs, :dlats =>dlats, :dincs => dincs)
  return parameters
end