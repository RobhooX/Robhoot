...
\begin{Layer}[layer=1]
\draw[very thin,orange] (-.5,-.5) rectangle (2.5,2);
\node at (-.5,-.5)[below right]{Layer 1};
\end{Layer}

\begin{Layer}[layer=2]
\draw[very thin,red] (-.5,-.5) rectangle (2.5,2);
\node at (-.5,-.5)[below right]{Layer 2};
\end{Layer}

\begin{Layer}[layer=3]
\draw[very thin,blue] (-.5,-.5) rectangle (2.5,2);
\node at (-.5,-.5)[below right]{Layer 3};
\end{Layer}

\begin{Layer}[layer=4]
\draw[very thin,blue] (-.5,-.5) rectangle (2.5,2);
\node at (-.5,-.5)[below right]{Layer 4};
\end{Layer}

\begin{Layer}[layer=5]
\draw[very thin,blue] (-.5,-.5) rectangle (2.5,2);
\node at (-.5,-.5)[below right]{Layer 5};
\end{Layer}
