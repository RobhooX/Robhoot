...
\begin{tikzpicture}[scale=.9,every node/.style={minimum size=1cm},on grid]
  ...
  \begin{scope}[
    ...
    \draw[-latex,thick] (6.2,2) node[right]{$\mathsf{Pattern\ Inference}$}
    to[out=180,in=90] (4,2);

    %\draw[-latex,thick] (5.9,8.4) node[right]{$\mathsf{Visualization}$}
    %     to[out=180,in=90] (3.2,8);

    \draw[-latex,thick](5.8,-.3) node[right]{$\mathsf{Model\ Validation}$}
        to[out=180,in=90] (3.9,-1);

    \draw[-latex,thick](5.9,5) node[right]{$\mathsf{Complexity\ Reduction}$}
      to[out=180,in=90] (3.6,5);

    \draw[-latex,thick](5.9,8.4) node[right]{$\mathsf{Data\ Collection}$}
        to[out=180,in=90] (3.2,8);
    ...
    \draw[-latex,thick](4,-6) node[right]{$\mathsf{Visualization}$}
