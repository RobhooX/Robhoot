...
\markboth{Sabbatical request -- CJ Meli\'an}{Sabbatical request -- CJ Meli\'an} 
...
\noindent {\bf Duration of the sabbatical}: 6 months\\
...
\noindent{\bf M1} Submission proposal ``Distributed open-source automated research platform ($ROBHOOT$)''\\
