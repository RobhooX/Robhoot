...
\markboth{Motivation for sabbatical request -- CJ Meli\'an}{Motivation for sabbatical request -- CJ Meli\'an} 
...
%\begin{wrapfigure}{l}{0.86\textwidth}
  \begin{center}
        \hspace{0.25 in}\includegraphics[width=0.65\textwidth]{Figure3.eps}
     \vspace{-0.01 in}
     \caption{{\bf Figure 3: Interdisciplinarity and synthesis in science} will
...
\subsection{{\bf Automated research platforms}}
   ...
   %\begin{wrapfigure}{l}{0.86\textwidth}
  \begin{center}
        \hspace{-1.7 in}\includegraphics[width=1.25\textwidth]{Figure4}
     \end{center}
     \vspace{-0.15 in}
     \caption{{\bf Figure 4: Five layer automated research
