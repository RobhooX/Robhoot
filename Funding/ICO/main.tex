...
\lettrineabstract{\section{{\bf Summary}}
  ...
  knowledge gaps. We introduce an open research network targeting a
  reduction of knowledge gaps by generating open-access, immutable and
  reproducible global science reports. Such features encompass a
  ...
  science-enabled technology as a proof-of-principle to connect
