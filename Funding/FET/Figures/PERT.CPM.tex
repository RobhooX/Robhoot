...
%O1====================================================================          
          \node[rectangle split,rectangle split parts=5,draw,text centered,rounded corners]
          (1) {Start O1 \nodepart{two} \ 0 \nodepart{three} \ 0  \nodepart{four} \ 0  \nodepart{five} \ 0};

          \node[rectangle split,rectangle split parts=5,draw,text centered,rounded corners,below right=of 1]
          (2) {WP1 \nodepart{two} \ 1 \nodepart{three} \ 11  \nodepart{four} \ 2  \nodepart{five} \ 13};

           \node[rectangle split,rectangle split parts=5,draw,text centered,rounded corners,above right=of 1]
          (3) {WP2 \nodepart{two} \ 1 \nodepart{three} \ 11  \nodepart{four} \ 2  \nodepart{five} \ 13};

          \node[rectangle split,rectangle split parts=5,draw,text centered,rounded corners,right=of 1]
          (4) {WP3 \nodepart{two} \ 3 \nodepart{three} \ 13  \nodepart{four} \ 5  \nodepart{five} \ 15};
...
\draw[->,red,line width=0.25mm] (1)--(2) node[midway, right]{};
\draw[->,red,line width=0.25mm] (1)--(3) node[midway, right]{};
%\draw[->,dashed] (2)--(3);
