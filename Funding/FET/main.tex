...
graphs. {\bf WP9 to WP11, Sharing data-architecture (SDN),
  causal-knowledge graphs, and discovery-knowledge graphs in federated
  networks (SCN), respectively}: These packages will explore
scalability and security properties of sharing knowledge graphs using
different topologies of federated networks. For example, there can be
data-knowledge graphs belonging to specific categories of data but
they might be integrated with different data types to gain global
understanding of data-architecture (i.e., like letting people on
different social networks follow each other). Despite the dramatic
...
v.3.0, ({\bf WP12: Sharing discovery-knowledge graphs in federated
  networks, COVID-19 as a case study (CODCAN)}), will deploy sharing
...
$\mathcal{ROBHOOT}$ v.4.0, {\bf WP16: Automated Cooperative
  ...
  study (COADIN)}, will deploy and share automatically generated
discovery-knowledge graphs in federated networks for the COVID-19 case
study to contrast cooperative forecasting under poulations of scenarios.
